#include <UTFT.h> 
#include <URTouch.h>#include <WiFi.h>
...
extern unsigned short bird01[0x41A];
int x, y;
...
//  pinMode(button, INPUT);
  ...
  myGLCD.print("Attempting to connect to WPA network...", CENTER, 10); // Prints the string on the screen
